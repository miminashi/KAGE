  ...
  if(kage.kShotai == kage.kMincho){ // mincho
    ...
    if(a2 == 1 || a2 == 8 || a2 == 15){ //the last filled circle
      if(x3 == x4){
        ...
        poly.push(x4 - kage.kMinWidthT * 0.6, y4 + kage.kMinWidthT * 0.6);
        ...
        poly.push(x4 + Math.cos(rad) * kage.kMinWidthT * 0.8 * v + Math.sin(rad) * kage.kMinWidthT * 0.6 * v,
                  y4 + Math.sin(rad) * kage.kMinWidthT * 0.8 * v - Math.cos(rad) * kage.kMinWidthT * 0.6 * v);
  ...
  if(kage.kShotai == kage.kMincho){ // mincho
    ...
    if(a2 == 1 || a2 == 8 || a2 == 15){ //the last filled circle
      if(x2 == x3){
        ...
        poly.push(x3 - kage.kMinWidthT * 0.6, y3 + kage.kMinWidthT * 0.6);
        ...
        poly.push(x3 + Math.cos(rad) * kage.kMinWidthT * 0.8 * v + Math.sin(rad) * kage.kMinWidthT * 0.6 * v,
                  y3 + Math.sin(rad) * kage.kMinWidthT * 0.8 * v - Math.cos(rad) * kage.kMinWidthT * 0.6 * v);
